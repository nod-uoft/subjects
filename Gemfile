...
gem 'authenticated_system',       '2.5.7',        github: 'thl/authenticated_system',        tag: 'v2.5.7' #path: '../../thl/engines/authenticated_system'
...
gem 'nod_integration',            '0.1.1',        github: 'nod-uoft/nod_integration',        tag: 'v0.1.1' #path: '../engines/nod_integration'
gem 'subjects_engine',            '1.7.5',        github: 'shanti-uva/subjects_engine',      tag: 'v1.7.5' #path: '../../shanti/engines/subjects_engine'
...
gem 'terms_integration',          '0.1.0',        github: 'shanti-uva/terms_integration',    tag: 'v0.1.0' #path: '../../shanti/engines/terms_integration'
