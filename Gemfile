...
gem 'authenticated_system',       '2.5.8',        github: 'thl/authenticated_system',        tag: 'v2.5.8' #path: '../../thl/engines/authenticated_system'
...
gem 'nod_integration',            '0.1.2',        github: 'nod-uoft/nod_integration',        tag: 'v0.1.2' #path: '../engines/nod_integration'
